...
{
    public partial class UserControlController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public UserControlController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected UserControlController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public UserControlController Actions { get { return MVC.UserControl; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "UserControl";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "UserControl";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        {
            public readonly string UserControl = "UserControl";
        ...
        public class ViewsClass
        {
            ...
            public readonly string UserControl = "~/Views/UserControl/UserControl.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_UserControlController : CookBook.PL.Controllers.UserControlController
    {
        public T4MVC_UserControlController() : base(Dummy.Instance) { }

        [NonAction]
        partial void UserControlOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult UserControl()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.UserControl);
            UserControlOverride(callInfo);
            return callInfo;
        }
